                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars( $value1["LoginUsuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/usuarios/<?php echo htmlspecialchars( $value1["idUsuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/password" class="btn btn-default btn-xs"><i class="fa fa-unlock"></i> Alterar Senha</a>
